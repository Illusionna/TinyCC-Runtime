...
:libtcc1.a
@set O1=libtcc1.o crt1.o crt1w.o wincrt1.o wincrt1w.o dllcrt1.o dllmain.o chkstk.o bcheck.o IllusionnaRuntime.o
.\tcc -m32 -c ../lib/IllusionnaRuntime.c
...
@if errorlevel 1 goto :the_end
.\tcc -m64 -c ../lib/IllusionnaRuntime.c
